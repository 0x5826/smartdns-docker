...
BALCKLIST_URL_CDN="https://cdn.jsdelivr.net/gh/hezhijie0327/GFWList2AGH@main/gfwlist2smartdns/blacklist_lite.conf"
WHITELIST_URL_CDN="https://cdn.jsdelivr.net/gh/hezhijie0327/GFWList2AGH@main/gfwlist2smartdns/whitelist_lite.conf"

wget -q $BALCKLIST_URL_CDN -O /tmp/$BLACKLIST_FILE
if [ $? -eq 0 ];then
